...
if (!defined('input[type='submit']INPUT_HEIGHT'))
	define('input[type='submit']INPUT_HEIGHT', 40);
$form->addInput(array('type'=>'textarea','name'=>'note','style'=>'width: 600px; height:'.input[type='submit']INPUT_HEIGHT.'px;','value'=>$cl_note));
